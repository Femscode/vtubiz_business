...
<head>
    ...
    {{--
    <link href="/theme/html/demo2/dist/assets/plugins/global/plugins.bundle5883.css?v=7.2.9" rel="stylesheet"
        type="text/css" /> --}}
    {{--
    <link href="/theme/html/demo2/dist/assets/plugins/custom/prismjs/prismjs.bundle5883.css?v=7.2.9" rel="stylesheet"
        type="text/css" /> --}}
    {{--
    ...
    <div class="d-flex flex-column flex-root app-root" id="kt_app_root">
        ...
        " id="kt_app_header_menu" data-kt-menu="true">
                                ...
                                <div data-kt-menu-trigger="{default: 'click', lg: 'hover'}"
                                    ...
                                    <!--begin:Menu link--><span class="menu-link"><a href='/change-password'
                                            class="menu-title">Change Password</a><span
                                            class="menu-arrow d-lg-none"></span></span>
                            ...
                            <div class="d-flex flex-stack flex-wrap flex-lg-nowrap gap-4 gap-lg-10 pt-13 pb-6">
                                ...
                                <div class="page-title me-5">
                                    ...
                                    <h1
                                        ...
                                        <a class='btn btn-info btn-sm' href='/fundwallet'>Fund Wallet</a>
                                        <!--end::Description-->
                                    </h1>
                                    <!--end::Title-->
                                </div>
                                ...
                                <div class="row g-5 g-xl-8">
                                            ...
                                            <div class="col-6">
                                                ...
                                                <div class="card card-stretch">
                                                    ...
                                                    <a href="/profile"
                                                        ...
                                                        <span class="svg-icon svg-icon-3tx mb-5 ms-n1"><svg width="24"
                                                                height="24" viewBox="0 0 24 24" fill="none"
                                                                xmlns="http://www.w3.org/2000/svg">
                                                                <path
                                    ...
                                    <div class="col-xl-8 ps-xl-12">
                                        <div class='card p-4 mb-4'>
                                            ...
                                            <form action='{{ route("reset-forgot-pin") }}' method='post'> @csrf
                                                <div class="widget-content col-md-12">
                                                    ...
                                                    <p>Reset your pin? click <a style='color:red;cursor:pointer'
                                                            href='/change-pin'>here</a> to reset pin.</p>
                        ...
                        <div id="kt_app_footer"
                            ...
                            <div class="text-dark order-2 order-md-1">
                                ...
                                <a href="https://paycirclex.com/" target="_blank"
                                    class="text-gray-800 text-hover-primary">Paycirclex</a>
                            </div>
                            <!--end::Copyright-->
            ...
            <div class="card-body position-relative" id="kt_app_layout_builder_body">
                ...
                <div id="kt_app_settings_content" class="position-relative scroll-y me-n5 pe-5" data-kt-scroll="true"
                    ...
                    <form class="form" method="POST" id="kt_app_layout_builder_form"
                        action="https://preview.keenthemes.com/metronic8/demo34/index.php">
                        ...
                        <div class="card-body p-0">
                            ...
                            <div class="form-group">
                                <!--begin::Heading-->
                                <div class="mb-6">
                                    <h4 class="fw-bold text-dark">Change Theme</h4>
                                ...
                                <div class="row" data-kt-buttons="true"
                                    ...
                                    <div class="col-6">
                                        ...
                                        <label class="form-check-image form-check-success">
                                            ...
                                            <div class="form-check-wrapper">
                                                <img src="assets/media/preview/demos/demo34/light-ltr.png"
                                                    class="mw-100" alt="" />
                                            </div>
                                            <!--end::Image-->
                                    ...
                                    <div class="col-6">
                                        ...
                                        <label class="form-check-image form-check-success">
                                            <!--begin::Image-->
                                            <div class="form-check-wrapper">
                                                <img src="assets/media/preview/demos/demo34/dark-ltr.png" class="mw-100"
                                                    alt="" />
                                            </div>
                                            <!--end::Image-->
