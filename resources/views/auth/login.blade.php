                ...
                <div>
                  ...
                  <form method="post" action='{{ route("login") }}'>@csrf
                    <div class="text-center mb-11">
                      <!--begin::Title-->
                      <img class="mx-auto h-100px h-lg-150px  theme-light-show"
                    ...
                    <div class="fv-row mb-3">
                      <!--begin::Email-->
                      <input autocomplete="" type="email" name='email' placeholder="Email address"
                    ...
                    <div class="fv-row mb-3">
                      <!--begin::Password-->
                      <input type="password" placeholder="Password" autocomplete="" class="form-control bg-transparent"
                        required name='password' />
                      <!--end::Password-->
                    </div>
                    {{-- <div class="separator separator-content my-14">
                      <span class="w-125px text-gray-500 fw-semibold fs-7">Or with social accounts</span>
                    </div>
