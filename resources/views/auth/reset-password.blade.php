                    ...
                    <div class="w-lg-600px p-10 p-lg-15 mx-auto">
                        ...
                        <form method="POST" action="{{ route('password.update') }}">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="email" type="email" class="form-control @error('email') is-invalid @enderror" name="email" value="{{  $request->route('email') ?? old('email') }}" required autocomplete="email" autofocus>
