            ...
            <tbody>
                <tr>
                    <td style="text-align:center; padding: 40px">
                        <a href="https://{{ $brand_name }}.vtubiz.com/" rel="noopener" target="_blank">{{ $brand_name }}
                <tr>
                    <td style='text-align:center'>
                        <div
                            ...
                            <div style="padding-bottom: 40px; text-align:center;">
                                <a href="https://wa.me/234" rel="noopener"
                ...
                <tr>
                    <td style="font-size: 13px; text-align:center;padding: 20px; color: #6d6e7c;">
                        ...
                        <p>Copyright ©
                            <a href="https://{{ $brand_name }}.vtubiz.com" rel="noopener"
                                target="_blank">{{ $brand_name }}.vtubiz.com</a>.
                        </p>
                    </td>
                </tr>
    </div>
