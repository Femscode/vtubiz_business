        ...
        " id="kt_app_header_menu" data-kt-menu="true">
                                ...
                                <a href='/superadmin'
                                    ...
                                    <!--begin:Menu link--><span class="menu-link"><span
                                            class="menu-title">Purchase Transactions</span><span
                                ...
                                <a href='/user_management' class="menu-item  @if($active == 'airtime') here show menu-here-bg @endif menu-lg-down-accordion me-0 me-lg-2">
                                    <!--begin:Menu link--><span class="menu-link"><span class="menu-title">User Management</span></span>
                                ...
                                <a href='/data_price'
                                    ...
                                    <!--begin:Menu link--><span class="menu-link"><span class="menu-title">Data Price
                                            </span></span>
                                    <!--end:Menu link-->
                                ...
                                <a href='/all_withdrawals'
                                    class="menu-item  @if($active == 'withdrawal') here show menu-here-bg @endif menu-sub-lg-down-indention me-0 me-lg-2">
                                    <!--begin:Menu link--><span class="menu-link"><span class="menu-title">Withdrawals
                                        </span></span>
                                    <!--end:Menu link-->

                                </a>
                                <a href='/admin_giveaway'
                                    class="menu-item  @if($active == 'withdrawal') here show menu-here-bg @endif menu-sub-lg-down-indention me-0 me-lg-2">
                                    <!--begin:Menu link--><span class="menu-link"><span class="menu-title">Giveaways
                                        </span></span>
                                    <!--end:Menu link-->
