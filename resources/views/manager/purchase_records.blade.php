                              ...
                              <div class="col">
                                   <div class="card">
                                        <div class="card-body overflow-hidden position-relative">
                                             ...
                                             <h3 class="mb-0 fw-bold mt-3 mb-1">{{number_format($total_transactions)}}</h3>
                                             <a href='/food' class="text-muted">Total Transactions</a>
                         ...
                         <div class="card mt-4">
                              <div class="card-body">
                                   <div class="text-center">
                                        ...
                                        <h5><a href="javascript: void(0);" class="text-dark">Transaction Analysis
                                             </a></h5>
                                   </div>
