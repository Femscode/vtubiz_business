...
<head>
    <title>VTUBIZ | Manager Dashboard</title>
    <meta charset="utf-8" />
...
<body id="kt_app_body" data-kt-app-header-fixed-mobile="true" data-kt-app-toolbar-enabled="true" class="app-default">
    ...
    <div class="d-flex flex-column flex-root app-root" id="kt_app_root">
        ...
        " id="kt_app_header_menu" data-kt-menu="true">
                                ...
                                <a href='/manager/payment_transactions' class="menu-item  @if($active == 'pay_cttaste') here show menu-here-bg @endif menu-lg-down-accordion me-0 me-lg-2">
                                ...
                                <a href='/manager/user_management' class="menu-item  @if($active == 'airtime') here show menu-here-bg @endif menu-lg-down-accordion me-0 me-lg-2">
