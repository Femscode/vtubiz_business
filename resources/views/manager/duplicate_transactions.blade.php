                        ...
                        <table class="datatable table table-striped">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href='admin_delete_duplicate/confirm/{{ $tranx->id }}' onclick="return confirm('Are you sure you want to approve/debit this transaction?')" class='btn btn-success btn-sm'>Confirm/Debit User</a>
                                        <a href='admin_delete_duplicate/delete/{{ $tranx->id }}' onclick="return confirm('Are you sure you want to delete/disconfirm this transaction?')" class='btn btn-danger btn-sm'>Clear Transaction</a>
                                    </td>
                                </tr>
                                @endforeach
