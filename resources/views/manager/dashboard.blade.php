...
<div class="dash-header mb-5 d-flex flex-column flex-md-row justify-content-between align-items-md-end gap-3">
    <div>
        ...
        <p class="text-muted">Real-time performance metrics and recent activity.</p>
    </div>
    
    <div class="filter-section">
        <form action="{{ route('manager') }}" method="GET" id="filterForm" class="d-flex flex-wrap gap-2 justify-content-md-end">
...
<div class="dash-header mb-4 mt-5">
    <h3 class="serif">Profit Overview</h3>
</div>
...
<div class="row g-4 mb-5">
    <div class="col-md-4">
        <div class="stat-card" style="border-left: 4px solid var(--accent-orange)">
            ...
            <div class="text-muted small mt-2">Combined profit from all services</div>
        </div>
    </div>
    <div class="col-md-8">
        <div class="stat-card">
...
<div class="recent-table-card">
    <div class="d-flex align-items-center justify-content-between mb-4">
        <h4 class="serif mb-0">Recent Transactions</h4>
        <a href="/manager/transactions" class="btn btn-sm btn-outline-primary rounded-pill px-3">View All</a>
    </div>
            ...
            <tbody>
                ...
                <tr>
                    <td>
                        ...
                        <div class="text-muted text-xs">{{ $tranx->user->brand->brand_name ?? 'N/A' }}</div>
                    </td>
                    <td>{{ $tranx->title }}</td>
