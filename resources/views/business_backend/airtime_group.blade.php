            ...
            <div class="card mb-xl-10">
              <div class="card-header flex-wrap border-0 pt-6 pb-0">
                <div class="card-title">
                    ...
                    <a class='btn btn-success' data-bs-toggle="modal" data-bs-target="#exampleModal">Create New Group</a>
                ...
                <div class="card-body">
                    <table class='table m-0'>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href='/airtime_recipient/{{ $group->uid }}' class='btn sm btn-primary'>Add/View Recipients</a>
                                <a data-group_id='{{ $group->uid }}' data-total_amount="{{ number_format($group->recipient->sum('amount')) }}" class='recharge btn sm btn-success'>Recharge Group</a>
                                <a href='/group_airtime_transactions/{{ $group->uid }}' class='btn sm btn-info'>Transactions</a>
                                <a onclick="return confirm('Are you sure you want to delete this group?')" href='/delete_airtime_group/{{ $group->uid }}' class='btn sm btn-danger'>Delete Group</a>
