                    ...
                    <ul class="metismenu list-unstyled" id="side-menu">
                        ...
                        <li class="">
                            ...
                            <ul class="sub-menu mm-collapse" aria-expanded="false">
                                <li><a href="/payment_transactions" key="t-inbox">User's Payment Transactions</a></li>
                                <li><a href="/purchase_transactions" key="t-read-email">User's Purchase Transactions</a></li>
                        ...
                        <li>
                            <a href="/mytheme" class="">
                                <i class="bx bx-store-alt"></i>
                                <span key="t-layouts">Edit My Website</span>
                            </a>
