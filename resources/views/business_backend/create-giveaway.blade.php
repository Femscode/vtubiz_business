                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group row m-2">
                                ...
                                <div class="btn-group btn-group-example mb-3 col-md-12" role="group">
                                    <button id='raffle_btn' type="button" style='background:grey;color:#fff' class="btn btn-rounded btn-outline-secondary col-md-3" style=''>
                                        Raffle Draw
                                    </button>
                                    <button id='q_and_a_button' type="button" class="btn btn-rounded btn-outline-secondary col-md-3">
                                        Questions & Answers
                                    </button>
                                </div>
                            </div>
                                ...
                                <form id='raffle_form'>
                                    ...
                                    <div class="form-group row m-2">
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <input required name="raffle_name" id='raffle_name' class="form-control form-control-lg form-control-solid" type="text" placeholder="Enter a be-fitting name" />
                                    ...
                                    <div class="form-group row m-2">
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <input required name="raffle_part_no" id='raffle_part_no' class="form-control form-control-lg form-control-solid" type="number" placeholder="Max. No. Of Participant" />
                                    ...
                                    <div class="form-group row m-2">
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <input required name="no_of_winners" id='raffle_no_of_winners' class="form-control form-control-lg form-control-solid" type="number" placeholder="Total No. Of Winners expected" />
                                    ...
                                    <div class="form-group row m-2">
                                        ...
                                        <div class="col-md-12">
                                            <label class='fw-bolder'>Entry Fee (Optional)</label>
                                            <input required name="entry_fee" id='raffle_entry_fee' class="form-control form-control-lg form-control-solid" type="number" placeholder="Amount To Charge Participants" />
                                    ...
                                    <div class="form-group row m-2">
                                        ...
                                        <div id='data_plan' class="col-md-6 mt-2">
                                            <select required name="winner_price" id='raffle_winner_price' class="form-control form-control-lg">
                                        ...
                                        <div id='airtime_plan' style='display:none' class="col-md-6 mt-2">
                                            <input id='raffle_airtime_price' name='raffle_airtime_price' class='form-control form-control-lg' type='number' placeholder='Input Airtime Amount' min='100' />
                                        </div>
                                        <div id='cash_plan' style='display:none' class="col-md-6 mt-2">
                                            <input id='raffle_cash_price' name='raffle_cash_price' class='form-control form-control-lg' type='number' placeholder='Input Cash Prize Amount' min='500' />
                                        </div>
                                    </div>
                                    <div style='display:none' id='raffle_estimated_amount_block' class='alert alert-success'>
                            ...
                            <div style='display:none' id='q_and_a'>
                                <form id='q_form'>
                                                        ...
                                                        <div class="accordion" id="accordionExample2">
                                                            <div class="accordion-item">
                                                                <h2 class="accordion-header" id="headingOne2">
                                                                    <button class="accordion-button fw-medium" type="button" data-bs-toggle="collapse" data-bs-target="#collapseOne2" aria-expanded="true" aria-controls="collapseOne">
                                                            ...
                                                            <div class="accordion-item">
                                                                <h2 class="accordion-header" id="headingTwo2">
                                                                    <button class="accordion-button fw-medium collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseTwo2" aria-expanded="false" aria-controls="collapseTwo">
                                                            ...
                                                            <div class="accordion-item">
                                                                <h2 class="accordion-header" id="headingThree2">
                                                                    <button class="accordion-button fw-medium collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseThree2" aria-expanded="false" aria-controls="collapseThree">
                                                                        <b>What are the security measures put in place?</b>
                                                                    </button>
                                                                </h2>
                                    ...
                                    <div class="form-group row m-2">
                                        ...
                                        <div class="col-md-12">
                                            <label class='fw-bolder'>Giveaway Name</label>
                                            <input required name="q_name" id='q_name' class="form-control form-control-lg form-control-solid" type="text" placeholder="Enter a be-fitting name" />
                                    ...
                                    <div class="form-group row m-2">
                                        ...
                                        <div class="col-md-12">
                                            <label class='fw-bolder'>No. Of Lucky Winners</label>
                                            <input required name="q_no_of_winners" id='q_no_of_winners' class="form-control form-control-lg form-control-solid" type="number" placeholder="Max. No. of People that can get your questions correctly" />
                                    ...
                                    <div class="form-group row m-2">
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <input required name="q_time" id='q_time' class="form-control form-control-lg form-control-solid" type="number" placeholder="Quiz duration" />
                                    ...
                                    <div class="form-group row m-2">
                                        ...
                                        <div class="col-md-12">
                                            <label class='fw-bolder'>Entry Fee (Optional)</label>
                                            <input required name="q_entry_fee" id='q_entry_fee' class="form-control form-control-lg form-control-solid" type="number" placeholder="Amount to charge each participants" />
                                    ...
                                    <div class="form-group row m-2">
                                        ...
                                        <div id='q_data_plan' class="col-md-6 mt-2">
                                            <select required id='q_winner_price' class="form-control form-control-lg">
                                                {{-- <option>--Select Data Plan--</option> --}}
                                                <option data-price="180" value="500MB">500MB</option>
                                                <option data-price='290' value="1GB">1GB</option>
                                                <option data-price='590' value="2GB">2GB</option>
                                        ...
                                        <div id='q_airtime_plan' style='display:none' class="col-md-6 mt-2">
                                            <input id='q_airtime_price' name='q_airtime_price' class='form-control form-control-lg' type='number' placeholder='Input Airtime Amount' min='100' />
                                        </div>
                                        <div id='q_cash_plan' style='display:none' class="col-md-6 mt-2">
                                            <input id='q_cash_price' name='q_cash_price' class='form-control form-control-lg' type='number' placeholder='Input Cash Price Amount' min='500' />
                                        </div>
                                    </div>
                                    <div style='display:none' id='q_estimated_amount_block' class='alert alert-success'>
