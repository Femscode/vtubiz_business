            ...
            <div class="col-md-12">
                ...
                <div style='border:1px dashed #3c763d;background-color:#fff;'class="card card-custom">
                    ...
                    <div class="card-body">
                        ...
                        <div style='background:#e2e3e5;border:2px dotted #41464b;border-radius:3px' class="card card-dashed bg-light-secondary flex-row flex-stack flex-wrap p-6 m-2">
                            <!--begin::Info-->
