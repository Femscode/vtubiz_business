              ...
              <div class="card-header flex-wrap border-0 pt-6 pb-0">
                <div class="card-title">
                  <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    ...
                    <a class='btn btn-primary' data-bs-toggle="modal" data-bs-target="#exampleModal">Create Recipient</a>
                </div>
                    ...
                    <table id='myTable' class='table m-0'>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a onclick='return confirm("Are you sure you want to delete this recipient?")' href='/delete_recipient/{{ $reci->uid }}' class='btn sm btn-danger'>Delete</a>
