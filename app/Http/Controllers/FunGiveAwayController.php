...
class FunGiveAwayController extends Controller
{
    ...
    public function claim_price($giveaway_id, $user_id, $rand_no)
    {
        ...
        $data['won'] = 1;
        $data['mtn'] = $mtn = Data::where('user_id', 0)->where('network', 1)->where('plan_name', 'like', '%' . $giveaway->winner_price . '%')->first();
        $data['glo'] = $glo = Data::where('user_id', 0)->where('network', 2)->where('plan_name', 'like', '%' . $giveaway->winner_price . '%')->first();
        $data['airtel'] = $airtel = Data::where('user_id', 0)->where('network', 3)->where('plan_name', 'like', '%' . $giveaway->winner_price . '%')->first();
        $data['n_mobile'] = $n_mobile = Data::where('user_id', 0)->where('network', 4)->where('plan_name', 'like', '%' . $giveaway->winner_price . '%')->first();
